...
/** @brief Тип функции для индикации процесса загрузки ПЛИС.
     ...
     */
typedef void (*TLTR210_LOAD_PROGR_CB)(void* cb_data, TLTR210* hnd, DWORD done_size, DWORD full_size);
...
/***************************************************************************//**
   ...
   @param[in] slot      Номер слота крейта, в котором установлен интересующий модуль.
                        Значение от CC_MODULE1 до CC_MODULE16.
   @return              Код ошибки
*******************************************************************************/
